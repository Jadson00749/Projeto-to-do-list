...
<template>
  <div class="h-full" v-if="displayTasks()">
      ...
      <div class="h-full flex items-center">
        <div class="h-[80%] w-[82%] flex flex-col" :class="storeToDoList.getdisplayMenuLeft ? '!w-full ml-auto' : ''">
          <div class="h-full flex items-center gap-2 pl-2">
            <button><HomeIcon class="w-[23px] h-[60%] color-btn-classific" v-if="!storeToDoList.getdisplayMenuLeft" /></button>
            ...
            <span class="color-btn-classific font-semibold important-font-title">Tarefas</span>
            <div class=" h-full">
...
<script setup>
import { EllipsisHorizontalIcon, HomeIcon, CalendarIcon, BellIcon, ArrowPathRoundedSquareIcon, Bars3Icon, StarIcon, ArrowsUpDownIcon, Battery0Icon } from '@heroicons/vue/24/solid'
...
const displayTasks = () => ref(storeToDoList.getdisplayTasks)
